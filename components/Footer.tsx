    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            <li><a href="#" onClick={(e) => handleNavClick(e, '/o-nas')} className="hover:text-emerald-500 transition-colors">O nas</a></li>
            <li><a href="#" onClick={(e) => handleNavClick(e, '/kariera')} className="hover:text-emerald-500 transition-colors">Kariera</a></li>
            <li><a href="#" onClick={(e) => handleNavClick(e, '/polityka-prywatnosci')} className="hover:text-emerald-500 transition-colors">Polityka Prywatności</a></li>
            <li><a href="#" onClick={(e) => handleNavClick(e, '/regulamin')} className="hover:text-emerald-500 transition-colors">Regulamin</a></li>
          </ul>
        </div>
